...
## Corpus Check
- 222 files · ~150,382 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2942 nodes · 9015 edges · 145 communities (137 shown, 8 thin omitted)
- Extraction: 61% EXTRACTED · 39% INFERRED · 0% AMBIGUOUS · INFERRED: 3526 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4736440d`
...
Cohesion: 0.11
Nodes (145): AbstractEventLoop, apply_caption_style_patch(), build_caption_response(), _style_response(), build_render_plan(), Final render orchestration for API jobs., Render the final MP4 on a background thread., Build a ``RenderPlan`` and assembly metadata from a filled storyboard. (+137 more)

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (66): apply_effects_patch(), assigned_slot_boundary_times_abs(), effective_window_end_s(), hook_teaser_for_storyboard(), Retention FX helpers for composited preview., Merge partial teaser / spatial FX / retention settings from an API patch., Build teaser spec from the hook slot when enabled., Absolute audio times where assigned slots begin or end. (+58 more)

### Community 2 - "Community 2"
Cohesion: 0.16
Nodes (35): BudgetPolicy, SpeedCurvePoint, JobConfig, MusicSection, BeatSyncFeatures, MusicSection, ndarray, Transient (+27 more)
...
Cohesion: 0.14
Nodes (43): _beat_index(), build_block_catalog(), _build_phrase_candidate(), _Candidate, _classify_candidate(), _correlation(), _duration_in_target_window(), _enumerate_all_phrase_candidates() (+35 more)
...
Cohesion: 0.12
Nodes (38): _allocate_items(), _allocate_tokens(), asr_words_from_serialized(), assign_transcribed_words_to_slot_overrides(), assign_transcribed_words_with_timing_to_slots(), build_caption_chunks_for_slots(), _distribute_by_budget(), distribute_words_with_timing_to_slots() (+30 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (109): save_upload(), write_job_config(), apply_storyboard_patch(), assign_slot_clip(), clear_slot_clip(), clip_media_for_storyboard(), _copy_slot_assignment(), hook_clip_id_for_slot() (+101 more)
...
Cohesion: 0.07
Nodes (75): analyze_audio_with_envelope(), _compute_surge_lane(), Windowed low→high RMS rise — peaks at steep surges that land loud., Analyze audio and return the timeline plus the onset strength envelope., classify_accents(), _ensure_hook_pan(), _ensure_slot_boundary_pans(), _ensure_tail_beat_pans() (+67 more)
...
Cohesion: 0.08
Nodes (51): Path, ClipInput, MediaInfo, TeaserSpec, TeaserConfig, _minimal_job_payload(), MonkeyPatch, Path (+43 more)

### Community 20 - "Community 20"
Cohesion: 0.10
Nodes (44): _drop_counts_by_slot(), plan_storyboard(), Map assigned slots to speed segments, roles, and parallel slot ids., Partition a music block into downbeat-aligned slots., _slot_labels(), _slot_rationales(), storyboard_to_segments(), _assert_slots_tile_timeline() (+36 more)
...
Cohesion: 0.09
Nodes (41): _count_zero_duration_words(), distribute_script_to_slot_overrides(), distribute_script_with_timing_to_slots(), Distribute script words across storyboard slots and group into phrase chunks., Return the suggested word budget for a slot at the given reading speed., Split script text into word tokens., Allocate a full script across slots using each slot's reading-speed budget., Allocate script text across slots, preserving ASR word timing when still valid. (+33 more)
...
Cohesion: 0.11
Nodes (27): Path, SpeedRampPlan, Tests for speed-ramp proxy filtergraph builder., _sample_plan(), test_build_composite_filtergraph_rotation_and_cover(), test_build_composite_filtergraph_spatial_crop(), test_build_composite_filtergraph_spatial_crop_letterbox(), test_build_composite_filtergraph_xfade_and_drawtext() (+19 more)
...
Cohesion: 0.10
Nodes (61): AudioAnalysisResult, Timeline plus reusable DSP features for downstream planners., BeatSyncFeatures, Beat-synchronous matrices for structure and loop planning., build_chroma_gram(), build_scope_lane_series(), build_waveform_payload(), downsample_envelope() (+53 more)
...
Cohesion: 0.10
Nodes (36): _clamp_boundary_count(), _collect_salient_candidates(), _compute_boundaries(), _downbeats_in_window(), effective_output_duration(), _greedy_salient_cuts(), hook_payoff_downbeats_s(), _nearest_time_in_range() (+28 more)
...
Cohesion: 0.09
Nodes (39): create_app(), FastAPI application factory for the Control Room., job_workspace(), FastAPI, Path, T, client(), _create_job_with_catalog() (+31 more)
...
Cohesion: 0.11
Nodes (39): CaptionStyle, SpeedSegment, test_build_caption_filter_chain_karaoke_uses_per_line_offsets(), test_single_line_caption_uses_top_line_slot_in_two_line_block(), _base_font_size(), build_caption_filter_chain(), build_composite_filtergraph(), build_hook_title_overlay() (+31 more)
...
Cohesion: 0.23
Nodes (15): AudioAnalysisError, AudioDspConfig, Raised when audio DSP fails., Tunable parameters for onset and transient detection., StageAction, JobConfig, Path, PipelineEvent (+7 more)
...
Cohesion: 0.18
Nodes (13): apply_hook_inversion_layout(), _full_hook_crop(), _hook_assigned_clip_id(), _hook_source_range_for_split(), Contiguous hook source span for 1:1 payoff/build crop windows., Split the hook into start/end storyboard slots aligned to the music block., Path, test_apply_hook_inversion_layout_splits_hook_slots() (+5 more)
...
Cohesion: 0.10
Nodes (28): CaptionChunk, SpeedRampPlan, TeaserSpec, CaptionChunk, CaptionStyle, SpeedRampPlan, SpeedSegment, test_captions_overlay_after_spatial_fx_for_steady_text() (+20 more)
...
Cohesion: 0.17
Nodes (20): _duration_from_probe(), _ensure_output_writable(), IngestError, IngestResult, _log_vfr_warning(), _parse_duration(), parse_frame_rate(), _pick_stream() (+12 more)
...
Cohesion: 0.25
Nodes (9): cleanup_caption_texts(), cleanup_script_text(), cleanup_slot_overrides(), Normalize the full script and each slot's effective caption text., Normalize a pasted/transcribed script before auto-allocating it to slots.      S, Normalize per-slot caption override text., test_cleanup_caption_texts_cleans_explicit_slot_overrides(), test_cleanup_caption_texts_normalizes_script_and_populates_slot_overrides() (+1 more)
...
Cohesion: 0.26
Nodes (16): extract_audio_track(), Extract a mono 16 kHz wav segment from a media file for ASR., _cleanup_scratch(), Transcription source handlers for caption auto-fill., _scratch_dir(), transcribe_from_audio_track(), transcribe_from_clips(), transcribe_from_custom_upload() (+8 more)
...
Cohesion: 0.09
Nodes (33): CompletedProcess, Path, test_caption_filtergraph_renders_special_characters(), test_escape_drawtext_text_handles_special_characters(), test_ensure_ffmpeg_succeeds_when_binaries_on_path(), _binary_version(), ensure_ffmpeg(), escape_drawtext_text() (+25 more)
...
Cohesion: 0.31
Nodes (8): _composite_graph_for_phrase(), Regression tests for drawtext escaping in caption filters., test_caption_filtergraph_survives_apostrophe_in_phrase(), test_caption_filtergraph_survives_percent_and_colon(), test_build_caption_filter_chain_wraps_long_phrase_to_two_lines(), test_build_composite_filtergraph_pads_video_to_storyboard_duration_for_captions(), CaptionChunk, A short phrase (2–4 words) shown together on screen.
...
- **Why does `DomainModel` connect `Community 30` to `Community 0`, `Community 1`, `Community 33`, `Community 3`, `Community 2`, `Community 34`, `Community 70`, `Community 133`, `Community 67`, `Community 15`, `Community 111`, `Community 18`, `Community 19`, `Community 22`, `Community 23`, `Community 57`, `Community 25`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `analyze_audio_with_envelope()` connect `Community 15` to `Community 36`, `Community 7`, `Community 141`, `Community 20`, `Community 23`, `Community 25`, `Community 30`, `Community 57`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `FFmpegError` connect `Community 0` to `Community 64`, `Community 67`, `Community 3`, `Community 70`, `Community 106`, `Community 13`, `Community 27`?**
