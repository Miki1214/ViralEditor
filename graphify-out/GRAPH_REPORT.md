...
## Corpus Check
- 223 files · ~151,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2962 nodes · 9089 edges · 133 communities (125 shown, 8 thin omitted)
- Extraction: 61% EXTRACTED · 39% INFERRED · 0% AMBIGUOUS · INFERRED: 3552 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `76204ee5`
...
Cohesion: 0.06
Nodes (71): apply_effects_patch(), assigned_slot_boundary_times_abs(), effective_window_end_s(), hook_teaser_for_storyboard(), Retention FX helpers for composited preview., Merge partial teaser / spatial FX / retention settings from an API patch., Build teaser spec from the hook slot when enabled., Absolute audio times where assigned slots begin or end. (+63 more)

### Community 2 - "Community 2"
Cohesion: 0.10
Nodes (59): AudioAnalysisResult, AudioDspConfig, Tunable parameters for onset and transient detection., Timeline plus reusable DSP features for downstream planners., BeatFeaturesMeta, BeatSyncFeatures, load_features(), Serializable metadata for beat-synchronous features. (+51 more)
...
Cohesion: 0.10
Nodes (36): distribute_script_to_slot_overrides(), Distribute script words across storyboard slots and group into phrase chunks., Return the suggested word budget for a slot at the given reading speed., Split script text into word tokens., Allocate a full script across slots using each slot's reading-speed budget., Align stored ASR word timings with edited override text.    Returns updated timi, reconcile_word_timing_override(), split_script_into_chunks() (+28 more)
...
Cohesion: 0.05
Nodes (121): build_job_config(), save_upload(), write_job_config(), apply_storyboard_patch(), assign_slot_clip(), clear_slot_clip(), clip_media_for_storyboard(), _copy_slot_assignment() (+113 more)
...
Cohesion: 0.24
Nodes (11): build_caption_chunks_for_slots(), cleanup_caption_texts(), cleanup_script_text(), cleanup_slot_overrides(), Normalize the full script and each slot's effective caption text., Normalize a pasted/transcribed script before auto-allocating it to slots.      S, Normalize per-slot caption override text., Build per-slot caption chunks from a caption config and ordered slots. (+3 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (63): apply_block_selection(), _bar_period(), _beat_period(), _Candidate, _chroma_slice(), _classify_window(), _correlation_score(), _envelope_slice() (+55 more)
...
Cohesion: 0.21
Nodes (30): MusicSection, _assert_tiles_output(), _flat_envelope(), AudioTimeline, MediaInfo, ndarray, Path, SpeedRampPlan (+22 more)

### Community 19 - "Community 19"
Cohesion: 0.22
Nodes (18): _block(), _clip_media(), _generate_test_audio(), _generate_test_clip(), _make_hook_split_storyboard(), _probe_duration_s(), MediaInfo, MusicBlock (+10 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (57): apply_hook_inversion_layout(), _downbeats_in_window(), hook_payoff_downbeats_s(), plan_storyboard(), Map assigned slots to speed segments, roles, and parallel slot ids., Partition a music block into downbeat-aligned slots., Valid hook-start durations on the music downbeat grid within hook budget., Snap a requested hook payoff to the nearest valid downbeat position. (+49 more)
...
Cohesion: 0.06
Nodes (63): AudioAnalysisError, Raised when audio DSP fails., _duration_from_probe(), _ensure_output_writable(), IngestError, _log_vfr_warning(), _parse_duration(), parse_frame_rate() (+55 more)
...
Cohesion: 0.11
Nodes (28): CaptionChunk, CaptionChunk, CaptionStyle, SpeedRampPlan, Tests for speed-ramp proxy filtergraph builder., _sample_plan(), test_build_composite_filtergraph_hook_start_mask_and_spatial_fx(), test_build_composite_filtergraph_pads_video_to_storyboard_duration_for_captions() (+20 more)
...
Cohesion: 0.08
Nodes (48): assigned_storyboard_slots(), _clamp_boundary_count(), _collect_salient_candidates(), _composite_video_start_for_assigned_index(), _compute_boundaries(), _drop_counts_by_slot(), effective_output_duration(), _full_hook_crop() (+40 more)
...
Cohesion: 0.10
Nodes (30): SpeedSegment, build_hook_title_overlay(), build_proxy_filtergraph(), build_teaser_filter_chain(), drawtext_hook_overlay(), _enable_between_expr(), _enable_union_expr(), _ffmpeg_boxcolor() (+22 more)

### Community 53 - "Community 53"
Cohesion: 0.07
Nodes (61): apply_clip_updates(), build_reel_for_config(), clip_durations_map(), clip_info_payload(), load_clip_reel(), persist_clip_reel(), primary_video_media(), probe_clip_media() (+53 more)
...
Cohesion: 0.06
Nodes (61): Path, SpeedRampConfig, ClipInput, MediaInfo, TeaserSpec, TeaserConfig, _minimal_job_payload(), MonkeyPatch (+53 more)

### Community 57 - "Community 57"
Cohesion: 0.10
Nodes (65): BudgetPolicy, SpeedCurvePoint, SpeedPreset, Path, SpeedRampConfig, SpeedRampPlan, TeaserSpec, SpeedSegment (+57 more)
...
Cohesion: 0.11
Nodes (42): _allocate_items(), _allocate_tokens(), asr_words_from_serialized(), assign_transcribed_words_to_slot_overrides(), assign_transcribed_words_with_timing_to_slots(), _count_zero_duration_words(), _distribute_by_budget(), distribute_script_with_timing_to_slots() (+34 more)
...
Cohesion: 0.07
Nodes (47): CompletedProcess, Path, Path, T, _composite_graph_for_phrase(), Regression tests for drawtext escaping in caption filters., test_caption_filtergraph_renders_special_characters(), test_caption_filtergraph_survives_apostrophe_in_phrase() (+39 more)
...
Cohesion: 0.31
Nodes (9): ReelEntry, ClipReel, SpeedSegment, test_clip_models_round_trip(), _entry_for_reel_time(), localize_segments(), Split reel-time segments at clip boundaries with per-clip source coordinates., One contiguous span on the virtual reel timeline. (+1 more)
...
Cohesion: 0.23
Nodes (19): WpsPreset, extract_audio_track(), Extract a mono 16 kHz wav segment from a media file for ASR., _cleanup_scratch(), Transcription source handlers for caption auto-fill., _scratch_dir(), transcribe_from_audio_track(), transcribe_from_clips() (+11 more)
...
Cohesion: 0.27
Nodes (9): Path, SpeedRampPlan, _append_looped_music_input(), Low-resolution speed-ramp proxy render for UI preview., Render a cached low-res proxy clip with trimmed music mux., Expose segments for tests and callers., Append a seamlessly looped music input (index = inputs already in command)., render_speed_proxy() (+1 more)
...
- **Why does `run_pipeline()` connect `Community 22` to `Community 3`, `Community 6`, `Community 70`, `Community 9`, `Community 14`, `Community 53`, `Community 56`, `Community 25`, `Community 59`, `Community 28`, `Community 30`, `Community 57`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `DomainModel` connect `Community 2` to `Community 0`, `Community 1`, `Community 153`, `Community 106`, `Community 15`, `Community 18`, `Community 30`, `Community 22`, `Community 23`, `Community 56`, `Community 25`, `Community 90`, `Community 59`, `Community 94`, `Community 57`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `analyze_audio_with_envelope()` connect `Community 59` to `Community 2`, `Community 36`, `Community 7`, `Community 15`, `Community 20`, `Community 22`, `Community 23`, `Community 25`, `Community 30`?**
